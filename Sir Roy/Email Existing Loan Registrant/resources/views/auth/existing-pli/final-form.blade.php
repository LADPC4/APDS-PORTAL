            ...
            <div class="mb-6">
                ...
                <div class="bg-blue-50 dark:bg-blue-900 p-4 rounded-lg mb-4">
                    <div class="flex items-center">
                        ...
                        <div>
                            <p class="text-sm font-medium text-blue-800 dark:text-blue-200">Your login email address:</p>
                            <p class="text-lg font-semibold text-blue-900 dark:text-blue-100">{{ $existingPli->official_email }}</p>
                        </div>
                    </div>
                    <p class="text-xs text-blue-700 dark:text-blue-300 mt-2">This verified email will be used to log into your account.</p>
                </div>
            </div>
